...
prot_7_res_df = pd.DataFrame(prot_7_res_seq_l)
...
one_hot_7res_with_ac_x = oneHot_Amino_acid_vec(prot_7_res_df[0])

save_path = 'UPDATE'
np.save(save_path + 'ground_truth_b1h_pwm_with_ac_x', pwm)
np.save(save_path + 'onehot_encoding_7b1h_res_with_ac_x', one_hot_7res_with_ac_x)
...
# drop from data dataframe the protein sequnces with amino acid X
